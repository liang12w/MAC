 ...
 */
@JsonIgnoreProperties(value={"adminAccountFrozenLog","followsesForFollowerId","adminCommentReviewLogs","adminMomentsReviewLogs","followsByUsrId","likeses", "commentses", "momentses","groupMemberses", "userPassword"})
